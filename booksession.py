...
try:
    ...
    login_button = WebDriverWait(driver, 20).until(
        EC.element_to_be_clickable((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Login")'))
    )
    login_button.click()
    ...
    phone_field.send_keys('3244597437')
    ...
    book_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Book session")'))
    )
    book_button.click()

    # Choose session type
    booktype_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Educational (40 mins)")'))
    )
    booktype_button.click()

    # # Choose session type
    # booktype_button = WebDriverWait(driver, 20).until(
    #     EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Follow up (20 mins)")'))
    # )
    # booktype_button.click()

    # Choose Date
    date_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Please select date")'))
    )
    date_button.click()

    # Choose Date
    date_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("25")'))
    )
    date_button.click()

    # Choose Date
    date_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("July")'))
    )
    date_button.click()

    # Choose Date
    date_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("2024")'))
    )
    date_button.click()

    # Choose Date
    date_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Confirm")'))
    )
    date_button.click()


    # Choose Time
    time_field = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Choose time").instance(1)'))
    )
    time_field.click()

    # Choose Time
    time_field = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("20 : 40")'))
    )
    time_field.click()


    # Write Details
    details_input = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("write any details if there")'))
    )
    details_input.send_keys('Yes,Thank You.')
