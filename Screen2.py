...
try:
    ...
    phone_field.send_keys('3068046168')
    ...
    edit_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Edit")'))
    )
    edit_button.click()

    # Choose Date
    date_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located((By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("26")'))
    )
    date_button.click()
    ...
    # Next
    screen3_button = WebDriverWait(driver, 20).until(
        EC.presence_of_element_located(
            (By.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Type 1 diabetes")'))
    )
    screen3_button.click()
