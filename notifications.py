...
try:
    ...
    # Notifications
    notifcations_icon = WebDriverWait(driver, 20).until(
        EC.element_to_be_clickable(
            (By.ANDROID_UIAUTOMATOR, 'new UiSelector().className("com.horcrux.svg.PathView").instance(0)'))
    )
    notifcations_icon.click()
